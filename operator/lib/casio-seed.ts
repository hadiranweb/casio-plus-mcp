...
const agents: Agent[] = [
  { id: 'casio-architect', departmentId: 'dept-knowledge', name: 'معمار سیستم', role: 'معمار سیستمسازی', status: 'active', tier: 'lead', description: 'مالک توپولوژی Vault، MOC، استانداردها و یکپارچگی ساختاری هسته دانش.', model: 'casio-plus-mcp', tools: ['knowledge-retrieval', 'architecture-map'], parentId: null, instance: 'builtin' },
  { id: 'casio-methodology', departmentId: 'dept-learning', name: 'طراح متدولوژی', role: 'طراح متدولوژی', status: 'active', tier: 'lead', description: 'دانش میدان را به پلی‌بوک‌ها، قالب‌ها و مسیرهای یادگیری قابل استفاده مجدد تبدیل می‌کند.', model: 'casio-plus-mcp', tools: ['playbook-design', 'template-library'], parentId: null, instance: 'builtin' },
  { id: 'casio-data', departmentId: 'dept-data', name: 'تحلیلگر داده', role: 'تحلیلگر داده', status: 'active', tier: 'specialist', description: 'مالک مدل‌های داده، رجیستری‌ها، سنجه کاسیو و قواعد کیفیت داده.', model: 'casio-plus-mcp', tools: ['data-quality-gate', 'metric-registry'], parentId: null, instance: 'builtin' },
  { id: 'casio-memory', departmentId: 'dept-knowledge', name: 'مدیر حافظه داده', role: 'مدیر حافظه داده', status: 'active', tier: 'specialist', description: 'رجیستری تصمیم‌ها، گزارش‌های یادگیری، منشأ و تداوم نسخه‌ها را نگه‌داری می‌کند.', model: 'casio-plus-mcp', tools: ['feedback-intake', 'version-proposals'], parentId: 'casio-architect', instance: 'builtin' },
  { id: 'casio-automation', departmentId: 'dept-data', name: 'مالک اتوماسیون', role: 'مالک اتوماسیون', status: 'training', tier: 'specialist', description: 'پلی‌بوک‌ها و قراردادهای داده اعتبارسنجی‌شده را به مشخصات اتوماسیون کنترل‌شده تبدیل می‌کند.', model: 'casio-plus-mcp', tools: ['automation-spec', 'approval-gate'], parentId: 'casio-data', instance: 'builtin' },
  { id: 'casio-documentation', departmentId: 'dept-coaching', name: 'مستندساز کوچینگ', role: 'مستندساز کوچینگ', status: 'active', tier: 'worker', description: 'جلسه‌ها، تصمیم‌ها، خروجی‌ها و بازخوردها را به‌عنوان حافظه سازمانی قابل استفاده مجدد ثبت می‌کند.', model: 'casio-plus-mcp', tools: ['coaching-session', 'feedback-intake'], parentId: 'casio-coach', instance: 'builtin' },
  { id: 'casio-compliance', departmentId: 'dept-governance', name: 'ناظر انطباق و استاندارد', role: 'ناظر انطباق و استاندارد', status: 'active', tier: 'specialist', description: 'استانداردها، دسترسی، منشأ و سیاست بازبینی را کنترل می‌کند.', model: 'casio-plus-mcp', tools: ['quality-gate', 'audit-log'], parentId: null, instance: 'builtin' },
  { id: 'casio-coach', departmentId: 'dept-coaching', name: 'کوچ فرایند', role: 'کوچ فرایند', status: 'active', tier: 'lead', description: 'مشاهدات میدان را به صف بازبینی می‌آورد و از پیاده‌سازی پشتیبانی می‌کند.', model: 'casio-plus-mcp', tools: ['action-plan', 'casio-metric'], parentId: null, instance: 'builtin' },
];
