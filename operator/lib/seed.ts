...
const agents: Agent[] = [
  // ── TECH: AI head ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
  {
    ...
    name: 'Conductor',
    role: 'پخش و ارکستراسیون',
    status: 'active',
    tier: 'lead',
    description: 'پیام شما را هم‌زمان به همه عامل‌ها پخش می‌کند و بررسی می‌کند کدام میزبان‌های نمونه (OpenClaw، Ollama، tmux) برای اتصال‌های آینده در دسترس‌اند.',
  ...
  // ── Communications: one instance, three channel workers feeding /comms ────────
  {
    ...
    name: 'عامل ارتباطات',
    role: 'نمونه ارتباطات یکپارچه',
    status: 'active',
    tier: 'lead',
    description: 'مالک فید یکپارچه /comms است. سه کارگر کانال خود را تجمیع و گزارش می‌کند کدام‌ها فعال‌اند.',
  ...
  },
  {
    ...
    departmentId: 'dept-comms',
    name: 'کارگر Gmail',
    role: 'صندوق‌های IMAP ×۴',
    status: 'planned',
    tier: 'worker',
    description: 'تعداد پیام‌های نخوانده و ایمیل‌های اخیر تا چهار صندوق IMAP را به /comms می‌آورد. با رسیدن اعتبارنامه‌های INBOX_* فعال می‌شود.',
    model: 'imapflow',
    tools: ['imap'],
  ...
  },
  {
    ...
    status: 'active',
    tier: 'worker',
    description: 'ChatStorage محلی واتس‌اپ (بیش از ۶۰۰ چت شامل تیم‌های LC و Vantage) را به /comms می‌خواند. همین امروز کار می‌کند.',
  ...
  },
  {
    ...
    status: 'planned',
    tier: 'worker',
    description: 'آخرین پیام‌های کانال‌های عضو را به /comms می‌آورد. به SLACK_BOT_TOKEN نیاز دارد.',
    model: '@slack/web-api',
    tools: ['slack'],
    parentId: 'comms-agent',
    instance: 'builtin',
  ...
  // ── Marketing/Growth: social/content crew ───────────────────────────
  {
    ...
    role: 'نمونه شبکه‌های اجتماعی و تولید محتوا',
    status: 'active',
    tier: 'lead',
    description: 'مالک انتشار و تولید محتواست. کارگرهای Zernio و Arcads را تجمیع می‌کند.',
    model: 'aggregate of workers',
  ...
  },
  {
    ...
    departmentId: 'dept-marketing-growth',
    name: 'ناشر Zernio',
    role: 'انتشار در شش پلتفرم',
    status: 'active',
    tier: 'worker',
    description: 'شش پلتفرم زیر @casio.plus را از طریق Zernio منتشر و پایش می‌کند. کلید همین‌جا موجود است — امروز کار می‌کند.',
    model: 'zernio api',
    tools: ['zernio'],
  ...
  },
  {
    ...
    departmentId: 'dept-marketing-growth',
    name: 'خلاق Arcads',
    role: 'تولید تبلیغات UGC',
    status: 'active',
    tier: 'worker',
    description: 'تبلیغات UGC برای Vantage (Veo/Sora/Kling) را از طریق API برنامه Arcads می‌سازد. احراز هویت روی این ماشین — امروز کار می‌کند.',
    model: 'arcads api',
    tools: ['arcads'],
    parentId: 'social-agent',
    instance: 'builtin',
  },
  {
    ...
    role: 'خط تدوین شبکه‌های اجتماعی',
    status: 'active',
    tier: 'worker',
    description: 'خط تدوین و رندر کلیپ‌های شبکه‌های اجتماعی، کپشن‌ها و کات‌های تبلیغاتی.',
  ...
  },
  {
    ...
    role: 'استودیو خلاق هوش مصنوعی',
    status: 'active',
    tier: 'worker',
    description: 'تولید خلاق Higgsfield برای دارایی‌های اجتماعی، عکس محصول و بصری کمپین‌ها.',
  ...
  },
  {
    ...
    departmentId: 'dept-marketing-growth',
    name: 'ManyChat MCP',
    role: 'اتوماسیون دایرکت',
    status: 'planned',
    tier: 'worker',
    description: 'مسیر MCP/API برنامه ManyChat برای اتوماسیون دایرکت‌ها، فلوهای کلیدواژه و جذب لید.',
    model: 'manychat api',
    tools: ['manychat'],
    parentId: 'social-agent',
    instance: 'builtin',
  },
  {
    ...
    name: 'عامل فروش',
    role: 'نمونه معاملات و پایپ‌لاین',
    status: 'active',
    tier: 'lead',
    description: 'مالک ستون فروش است. CRM Pulse را تجمیع و پایپ‌لاین زنده معاملات Attio را گزارش می‌کند.',
    model: 'aggregate of workers',
  ...
  },
  {
    ...
    status: 'planned',
    tier: 'worker',
    description: 'مسیر فروش گروه Launchpad: پیشنهادها، تماس‌ها، تأیید پرداخت و بافت CRM.',
    model: 'account lane',
  ...
  },
  {
    ...
    status: 'planned',
    tier: 'worker',
    description: 'مسیر فروش Vantage: پایپ‌لاین حساب‌ها، بافت FanBasis، تأیید پرداخت و داده تماس‌ها.',
    model: 'account lane',
    tools: ['attio', 'stripe', 'fanbasis'],
    parentId: 'sales-agent',
    instance: 'builtin',
  },
  {
    ...
    name: 'FanBasis',
    role: 'پلتفرم پیشنهاد و پرداخت',
    status: 'planned',
    tier: 'worker',
    description: 'اتصال پلتفرم فروش FanBasis برای پیشنهادها و بافت مشتری/پرداخت.',
    model: 'fanbasis api',
    tools: ['fanbasis'],
  ...
  },
  {
    ...
    role: 'مسیر FanBasis ونتج',
    status: 'planned',
    tier: 'worker',
    description: 'مسیر FanBasis مشخصاً زیر Vantage برای بافت پیشنهاد، پرداخت و مشتری.',
    model: 'fanbasis api',
    tools: ['fanbasis'],
  ...
  },
  {
    ...
    departmentId: 'dept-finance',
    name: 'Stripe',
    role: 'پردازنده پرداخت فروش',
    status: 'planned',
    tier: 'worker',
    description: 'مسیر تأیید پرداخت Stripe برای گردش‌کارهای فروش و کنترل درآمد سطح حساب.',
    model: 'stripe sdk',
    tools: ['stripe'],
    parentId: 'payments-pulse',
    instance: 'builtin',
  },
  {
    ...
    departmentId: 'dept-finance',
    name: 'تأیید پردازش',
    role: 'تأیید API پرداخت',
    status: 'planned',
    tier: 'worker',
    description: 'API به پردازنده‌های پرداخت برای تأیید وضعیت‌های پرداخت‌شده، ناموفق، مورد اعتراض و در انتظار.',
  ...
  },
  {
    ...
    role: 'گزینه‌های تأمین مالی',
    status: 'planned',
    tier: 'worker',
    description: 'مسیر گزینه‌های تأمین مالی PAVA برای پیشنهادها و بافت برنامه پرداخت.',
    model: 'pava api',
    tools: ['pava'],
    parentId: 'payments-pulse',
    instance: 'builtin',
  },
  {
    ...
    status: 'planned',
    tier: 'worker',
    description: 'مسیر داده تماس‌های فروش برای ضبط‌ها، یادداشت‌ها، نتایج و بافت پیگیری.',
    model: 'fathom + crm',
    tools: ['fathom', 'attio'],
    parentId: 'sales-agent',
    instance: 'builtin',
  ...
  // ── TECH: the G-Brain data analyst and its auditors ──────────────────────────────
  {
    ...
    departmentId: 'dept-tech',
    name: 'عامل داده',
    role: 'تحلیلگر جی‌برین',
    status: 'active',
    tier: 'lead',
    description: 'وابسته به نمونه جی‌برین: سلامت ذخیره‌سازی مارک‌داون + وکتور را تحلیل و ایده‌ها را مطرح می‌کند. به پخش‌ها با پرس‌وجو از مغز پاسخ می‌دهد.',
    model: 'gbrain CLI',
  ...
  },
  {
    ...
    departmentId: 'dept-tech',
    name: 'ممیز مارک‌داون',
    role: 'سلامت brain-store',
    status: 'active',
    tier: 'worker',
    description: 'brain-store مارک‌داون را مرور می‌کند: تعداد صفحات هر پوشه، فایل‌های سرگردان در ریشه، پوشه‌های خالی. همین امروز کار می‌کند.',
    model: 'fs walk',
    tools: ['brain-store'],
    parentId: 'data-agent',
    instance: 'builtin',
  },
  {
    ...
    departmentId: 'dept-tech',
    name: 'ممیز وکتور',
    role: 'سلامت pgvector / Supabase',
    status: 'active',
    tier: 'worker',
    description: 'gbrain doctor را اجرا می‌کند: اتصال به Supabase pgvector، کنترل embedding، امتیاز سلامت. همین امروز کار می‌کند.',
    model: 'gbrain doctor',
  ...
  },
  {
    ...
    role: 'خواننده فضای کاری',
    status: 'planned',
    tier: 'specialist',
    description: 'صفحه‌های ویرایش‌شده اخیرِ به‌اشتراک‌گذاشته‌شده با integration. به NOTION_API_KEY نیاز دارد.',
  ...
  // ── Finances ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  {
    ...
    departmentId: 'dept-finance',
    name: 'نبض پرداخت‌ها',
    role: 'پایشگر پردازنده',
    status: 'planned',
    tier: 'lead',
    description: 'موجودی Stripe + تراکنش‌های اخیر؛ PayPal/Square/Whop ثبت شده و منتظر کلیدند.',
    model: 'stripe sdk',
  ...
  },
  {
    ...
    departmentId: 'dept-sales',
    name: 'CRM Attio',
    role: 'پایپ‌لاین معاملات Attio',
    status: 'active',
    tier: 'worker',
    description: 'معاملات Vantage + LC از Attio، با کلید استفاده‌شده از پیکربندی MCP. همین امروز کار می‌کند.',
    model: 'attio api',
    tools: ['attio'],
    parentId: 'sales-agent',
    instance: 'builtin',
  ...
  // ── TECH: automations ─────────────────────────────────────────────────────────────────────────────────────────────────────
  {
    ...
    departmentId: 'dept-tech',
    name: 'پایشگر استک',
    role: 'سلامت استک محلی',
    status: 'active',
    tier: 'lead',
    description: 'آمار Remotion، Ollama، command-center، OpenClaw، tmux، whisper، ffmpeg، higgsfield، gh و Wispr Flow.',
    model: 'local checks',
  ...
  // ── Clients: roster, onboarding, service ──────────────────────────────────
  {
    ...
    name: 'فهرست مشتریان',
    role: 'فهرست زنده مشتریان',
    status: 'active',
    tier: 'lead',
    description: 'منبع حقیقت برای اینکه چه کسی مشتری است: Attio و FanBasis را با قیف تطبیق و فهرست را به‌روز نگه می‌دارد.',
    model: 'funnel + Attio',
  ...
  },
  {
    ...
    departmentId: 'dept-clients',
    name: 'عامل آنبوردینگ',
    role: 'از قرارداد تا شروع',
    status: 'planned',
    tier: 'worker',
    description: 'با بسته‌شدن معامله، SOP آنبوردینگ را سر تا سر اجرا می‌کند: بسته خوش‌آمد، راه‌اندازی فضای کاری، ثبت جلسه شروع، یادداشت‌های تحویل.',
  ...
  },
  {
    ...
    departmentId: 'dept-clients',
    name: 'موفقیت مشتری',
    role: 'سرویس و تمدیدها',
    status: 'planned',
    tier: 'worker',
    description: 'مشتریان فعال را سرویس‌دهی نگه می‌دارد: آهنگ check-in، پیگیری تحویل‌ها از یادداشت تماس، پرچم‌های تمدید و upsell.',
    model: 'fathom + slack',
    tools: ['fathom', 'slack'],
    parentId: 'client-roster',
    instance: 'builtin',
