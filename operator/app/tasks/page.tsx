...
export default function CoachingOperationsPage() {
  ...
  return <div dir="rtl">
    ...
    <section className="grid gap-4 xl:grid-cols-[1.55fr_.85fr]"><div className="rounded-lg-t border border-os-border bg-os-surface p-5"><SectionHead label="Coaching session log" count={`${sessions.length} sessions`} />
