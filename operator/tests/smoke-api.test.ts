...
const ROUTES: RouteEntry[] = [
  ...
  { route: 'automation-specs', load: () => import('@/app/api/automation-specs/route'), url: 'http://localhost/api/automation-specs' },
  { route: 'casio/access', load: () => import('@/app/api/casio/access/route'), url: 'http://localhost/api/casio/access' },
